...
LOCAL_MODULE_OWNER := nubia
LOCAL_SRC_FILES := proprietary/vendor/app/FingerprintServiceExtension/FingerprintServiceExtension.apk
...
LOCAL_MODULE_OWNER := nubia
LOCAL_SRC_FILES := proprietary/vendor/framework/ifaa_fingerprint.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
